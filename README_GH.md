...
### 🌳 **tree-chart.html** - Tree Chart Hierárquico
- **O quê**: Visualização em árvore estilo amCharts
- **Hierarquia**: Total → Status → Fonte → Canal
- **Como usar**:
  - Clique em nós para expandir/colapsar
  - Botões de controle para mudar orientação (vertical/horizontal)
  - Hover para ver valores exatos
  - Expandir/Colapsar todos com um clique
- **Características**:
  - Suporta orientação vertical e horizontal
  - Cores por status e fonte
  - Mostra canal dentro de cada fonte
  - Animações suaves

### 🔄 **tree-interactive.html** - Árvore Sunburst Interativa
- **O quê**: Visualização sunburst (gráfico de rosca aninhado)
